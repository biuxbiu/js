...
* [Dom & Event](object/#HTML-DOM)
    * [- 什么是 Dom](object/if.md)
    * [- 选择元素](object/else.md)
    * [- 改变属性](object/elseif.md)
    * [- 添加和移除元素](object/switch.md)
    * [- 创建动画](object/switch.md)
    * [- Events](object/switch.md)
    * [- 创建图像幻灯片](object/switch.md)
    * [- 表格验证](object/switch.md)
